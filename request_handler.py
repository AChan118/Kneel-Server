...
from views.metals_request import get_single_metal, update_metal
from views.orders_request import create_order, delete_order, get_single_order, update_order
from views.sizes_request import get_single_size
from views.styles_request import get_single_style
